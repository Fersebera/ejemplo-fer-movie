        ...
        public async Task<IActionResult> Registro(RegistroViewModel usuario)
        {
            if (ModelState.IsValid)
            {
                ...
                var nuevoUsuario = new Usuario
                {
                    ...
                    ImagenUrlPerfil = "/images/default-avatar.png" // Imagen por defecto
                };
                ...
                if (resultado.Succeeded)
                {
                    ...
                    await _emailService.SendAsync(nuevoUsuario.Email, "Bienvenido a Fer Movie!", "<h1>Gracias por registrarte en Fer Movie!</h1><p>Esperemos que disfrutes de nuestra plataforma.</p>");
                    return RedirectToAction("Index", "Home");
                }
                else
                {
